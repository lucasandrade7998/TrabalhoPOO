...
public class GastosCadastra
{
	...
	public GastosCadastra(double valor, Calendar data,Enum<tipoDeGasto> tipoDeGasto, String formaDePagamento)
	{
	...
	public String FormaPagamentoGet() {
		return formaDePagamento;
	}

	public void FormaPagamentoSet(String formaDePagamento) {
		this.formaDePagamento = formaDePagamento;
	}
	...
	public String toString()
	{
		...
		builder.append("\nForma de Pagamento: " +FormaPagamentoGet());
		builder.append("\n\n");
